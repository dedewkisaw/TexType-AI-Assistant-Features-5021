...
const { FiChrome, FiCode, FiEdit3, FiBookOpen, FiFileText, FiEye, FiGlobe, FiMail, FiImage, FiUsers, FiShield, FiArrowRight, FiMenu, FiX, FiStar, FiZap, FiTrendingUp, FiSmartphone, FiMonitor, FiTablet } = FiIcons;
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-2 rounded-full font-medium hover:shadow-lg transition-shadow"
              >
                Get Started
              </motion.button>
            </div>
        ...
        {isMenuOpen && (
          ...
          >
            <div className="px-4 py-4 space-y-4">
              ...
              <button className="w-full bg-gradient-to-r from-purple-500 to-pink-500 text-white px-6 py-2 rounded-full font-medium">
                Get Started
              </button>
            </div>
          </motion.div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <div className="flex space-x-4">
                <SafeIcon icon={FiMonitor} className="text-gray-400 hover:text-white cursor-pointer transition-colors" />
                <SafeIcon icon={FiSmartphone} className="text-gray-400 hover:text-white cursor-pointer transition-colors" />
                <SafeIcon icon={FiTablet} className="text-gray-400 hover:text-white cursor-pointer transition-colors" />
              </div>
            </div>
